...
let documentKeyInput = document.getElementById("documentKeyInput");
let moreInfoInput = document.getElementById("moreInfoInput");
let enemyInfo, armorClass, healthValues, minHealth, maxHealth, firstLine, initiativeBonus, providedName, documentKey;
